...
public class Inference extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Inference(java.util.List<java.lang.Double> vector, java.util.List<org.librairy.service.modeler.facade.model.TopicSummary> topics) {
    this.vector = vector;
    this.topics = topics;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: topics = (java.util.List<org.librairy.service.modeler.facade.model.TopicSummary>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<org.librairy.service.modeler.facade.model.TopicSummary> getTopics() {
    return topics;
  }
   ...
   * @param value the value to set.
   */
  public void setTopics(java.util.List<org.librairy.service.modeler.facade.model.TopicSummary> value) {
    this.topics = value;
  }

  /** Creates a new Inference RecordBuilder */
  public static org.librairy.service.modeler.facade.model.Inference.Builder newBuilder() {
    return new org.librairy.service.modeler.facade.model.Inference.Builder();
  }
  
  /** Creates a new Inference RecordBuilder by copying an existing Builder */
  public static org.librairy.service.modeler.facade.model.Inference.Builder newBuilder(org.librairy.service.modeler.facade.model.Inference.Builder other) {
    return new org.librairy.service.modeler.facade.model.Inference.Builder(other);
  }
  
  /** Creates a new Inference RecordBuilder by copying an existing Inference instance */
  public static org.librairy.service.modeler.facade.model.Inference.Builder newBuilder(org.librairy.service.modeler.facade.model.Inference other) {
    return new org.librairy.service.modeler.facade.model.Inference.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Inference>
    ...
    private Builder() {
      super(org.librairy.service.modeler.facade.model.Inference.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.librairy.service.modeler.facade.model.Inference.Builder other) {
      super(other);
    ...
    private Builder(org.librairy.service.modeler.facade.model.Inference other) {
            super(org.librairy.service.modeler.facade.model.Inference.SCHEMA$);
      if (isValidValue(fields()[0], other.vector)) {
        this.vector = data().deepCopy(fields()[0].schema(), other.vector);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'vector' field */
    public org.librairy.service.modeler.facade.model.Inference.Builder setVector(java.util.List<java.lang.Double> value) {
    ...
    public org.librairy.service.modeler.facade.model.Inference.Builder clearVector() {
      vector = null;
    ...
    /** Sets the value of the 'topics' field */
    public org.librairy.service.modeler.facade.model.Inference.Builder setTopics(java.util.List<org.librairy.service.modeler.facade.model.TopicSummary> value) {
    ...
    public org.librairy.service.modeler.facade.model.Inference.Builder clearTopics() {
      topics = null;
    ...
    public Inference build() {
      try {
        ...
        record.topics = fieldSetFlags()[1] ? this.topics : (java.util.List<org.librairy.service.modeler.facade.model.TopicSummary>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
