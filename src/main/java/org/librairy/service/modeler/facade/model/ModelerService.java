...
public interface ModelerService {
  ...
  java.util.List<org.librairy.service.modeler.facade.model.Element> elements(int dimensionId, int maxElements, int offset, boolean tfidf) throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends ModelerService {
    ...
    void elements(int dimensionId, int maxElements, int offset, boolean tfidf, org.apache.avro.ipc.Callback<java.util.List<org.librairy.service.modeler.facade.model.Element>> callback) throws java.io.IOException;
